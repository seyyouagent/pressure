    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"></i> 环境管理
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            <div class="handle-box">
                <el-button
                    ...
                    @click="handleAdd"
                >新 增</el-button>
                <el-input v-model="form.aliasName" placeholder="环境名称" class="handle-input mr10"></el-input>
                <el-input v-model="form.companyName" placeholder="公司名称" class="handle-input mr10"></el-input>
            ...
            >
                ...
                <el-table-column prop="companyName" label="环境名称"></el-table-column>
                <el-table-column prop="hierarchy" label="备注"></el-table-column>
